      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-4 mb-16">
          <div className="space-y-4">
            {[
              { icon: <MapPin size={16} className="text-gold" />, label: 'Location', content: <div className="text-sm leading-relaxed text-cream/80">123, Nehru Street<br />Tiruppur – 641 601<br />Tamil Nadu, India</div> },
              { icon: <Phone size={16} className="text-gold" />, label: 'Phone', content: <div><a href="tel:+919876543210" className="text-sm text-cream/80 hover:text-gold block">+91 98765 43210</a><a href="tel:+919876543211" className="text-sm text-cream/50 hover:text-gold block mt-1">+91 98765 43211</a></div> },
